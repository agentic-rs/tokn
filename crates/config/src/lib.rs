...
/// A deliberately narrow runtime configuration overlay generated by agent
/// integration tooling. Desired agent state belongs in `agent.yaml`; legacy
/// fragments may still contain an `[agents.*]` table during migration.
#[derive(Debug, Clone, Default, Deserialize)]
