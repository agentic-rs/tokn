      ...
      <li class=${l}>
        ...
        >
          ...
          <span class="session-node-context">
            ...
            <span aria-hidden="true">·</span>
            <span>${h.toLocaleString()} ${u}</span>
            <span aria-hidden="true">·</span>
            <span>${p.toLocaleString()} output</span>
          </span>
